...
namespace HomeWork_Lyulyaev
{
	public class Program
	{
		public static void Main(String[] args)
		{
			...
			Console.WriteLine($"{vector1}, {vector1.Addition(vector2)}");
			Console.WriteLine($"{vector2}, {vector2.Addition(vector3)}");
			Console.WriteLine($"{vector3}, {vector3.Subtraction(vector2)}");
